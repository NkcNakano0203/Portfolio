...
チーム人数：6人(プログラマー6)  
制作期間：  
(完成) 2023/2/10 ~ 2023/5/31（2ヶ月）  
(バグ修正+リファクタリング) 2023/6/1 ~ 2024/3/1（6ヶ月程度、不定期活動）  
開発環境：Unity(2022.3.18f1)、C#、CRIWARE(サウンド管理ツール)、DSPAcion(SE制作ツール)、GitHub、Sourcetree  
...
チーム人数：3人（プランナー１、プログラマー２）  
制作期間：2023/2/4 ~ 2023/2/5（2日間）  
開発環境：Unity(2021.3.11f1)  
主な担当箇所：プレイヤーの操作(雑草を抜く、強化)、タイトル画面  
...
## QUBEBoy
<iframe width="560" height="315" src="https://www.youtube.com/embed/gjN5St-PiWo" title="QUBEboy紹介動画" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

1年生の前期制作で制作した個人制作作品です。  
学年全体の投票で３位になりました。


個人制作  
制作期間：2021/9/8 ~ 2021/9/26（1ヶ月） 
開発環境：Unity(2020.3.7f1)、C#